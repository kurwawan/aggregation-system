...
Public Class ReportAgregasi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QRCodeProject.ReportAgregasi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportAgregasi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportAgregasi = New ReportAgregasi()
        rpt.Site = Me.Site
        Return rpt
    End Function
